...
def worker(args):
    ...
    maximum_delta = float(opt_config["max_adjacent_twist_delta_deg"])
    ...
    row = {
        ...
        **{f"T{i+1}_deg": value for i, value in enumerate(twist_values)},
        ...
        "max_adjacent_twist_delta_deg": design["max_adjacent_twist_delta_deg"],
        "max_abs_twist_deg": max(abs(value) for value in twist_values),
        "rotation_axis_x_over_c": design["rotation_axis_x_over_c"],
        ...
        "feasible": (
            ...
            and float(design["max_adjacent_twist_delta_deg"]) <= maximum_delta
        ),
    }
